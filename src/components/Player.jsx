...
export function Player() {
    const { seekBar, seekBg, playStatus, play, pause, track, time, playPrevious, playNext, seekSong } = useContext(PlayerContext);
        ...
        <div className="h-[10%] bg-black flex justify-between items-center text-white px-4">
            ...
            <div className="flex flex-col items-center gap-1 m-auto">
                <div className="flex gap-4">
                    ...
                    <img onClick={playPrevious} className="w-4 cursor-pointer" src={assets.prev_icon}/>
                    ...
                    <img onClick={playNext} className="w-4 cursor-pointer" src={assets.next_icon}/>
                ...
                <div className="flex items-center gap-5">
                    ...
                    <div ref={seekBg} onClick={seekSong} className="w-[60vw] max-w-[500px] bg-gray-200 rounded-full cursor-pointer">
                        <hr ref={seekBar} className="h-1 border-none w-10 bg-green-300 rounded-full"/>
                    </div>
